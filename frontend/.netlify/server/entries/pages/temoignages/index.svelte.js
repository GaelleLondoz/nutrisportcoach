...
const css = {
  code: '@import url("https://fonts.googleapis.com/css2?family=Hind:wght@400;500;700&family=Poppins:wght@400;600&display=swap");.svelte-qcg9iw.svelte-qcg9iw,.svelte-qcg9iw.svelte-qcg9iw::after,.svelte-qcg9iw.svelte-qcg9iw::before{box-sizing:border-box}.container.svelte-qcg9iw.svelte-qcg9iw{padding-right:1.6rem;padding-left:1.6rem;max-width:141.6rem;margin-right:auto;margin-left:auto}@media(max-width: 768px){}@media(min-width: 768px){}@media(min-width: 1024px){}@media(max-width: 1024px){}@media(min-width: 1024px){}@media(max-width: 768px){}@media(min-width: 768px){}@media(max-width: 1024px){}@media(min-width: 1024px){}.reviews.svelte-qcg9iw.svelte-qcg9iw{position:relative;display:flex;align-items:center;height:calc(100vh - var(--headerHeigth))}.reviews.svelte-qcg9iw.svelte-qcg9iw:before{content:"";position:absolute;top:0;left:0;width:100vw;background-color:#c6d6c2}.reviews.svelte-qcg9iw header.svelte-qcg9iw{position:relative;display:flex;justify-content:space-between;align-items:center}.reviews.svelte-qcg9iw header h1.svelte-qcg9iw{font-size:3rem;line-height:3rem;font-weight:500}.reviews.svelte-qcg9iw .link-to-creation-page.svelte-qcg9iw{display:flex;align-items:center;margin:3rem 0}.reviews.svelte-qcg9iw .link-to-creation-page a.svelte-qcg9iw{background:#486b3b;border-radius:1rem;color:#fff;font-size:2rem;line-height:1;font-weight:500;padding:1rem 3rem}@media(hover: hover) and (pointer: fine){.reviews.svelte-qcg9iw .link-to-creation-page a.svelte-qcg9iw:hover{background-color:#324a29}}.reviews.svelte-qcg9iw.svelte-qcg9iw:not(.no-reviews):before{height:calc(50vh - var(--headerHeigth) / 2)}.reviews.svelte-qcg9iw:not(.no-reviews) .link-to-creation-page.svelte-qcg9iw{justify-content:flex-end}.reviews.no-reviews.svelte-qcg9iw.svelte-qcg9iw:before{height:100%}.reviews.no-reviews.svelte-qcg9iw p.svelte-qcg9iw{position:relative;font-size:1.8rem;line-height:1.8rem;color:#1a2a34;margin:5rem 0 10rem}.reviews.no-reviews.svelte-qcg9iw .link-to-creation-page.svelte-qcg9iw{position:relative;justify-content:flex-start}',
  map: null
};
