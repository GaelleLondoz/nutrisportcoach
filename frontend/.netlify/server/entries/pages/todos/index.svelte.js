...
const Todos = (0, import_index_4688debc.c)(($$result, $$props, $$bindings, slots) => {
  let { todos } = $$props;
...
<div class="${"todos svelte-q3kvo1"}"><h1>Todos</h1>
	...
	${(0, import_index_4688debc.d)(todos, (todo) => {
    return `<div class="${["todo svelte-q3kvo1", todo.done ? "done" : ""].join(" ").trim()}"><form action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_4688debc.f)("value", todo.uid, 0)} class="${"svelte-q3kvo1"}">
				<input type="${"hidden"}" name="${"done"}"${(0, import_index_4688debc.f)("value", todo.done ? "" : "true", 0)} class="${"svelte-q3kvo1"}">
				<button class="${"toggle svelte-q3kvo1"}" aria-label="${"Mark todo as " + (0, import_index_4688debc.e)(todo.done ? "not done" : "done", true)}"></button></form>

			<form class="${"text svelte-q3kvo1"}" action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_4688debc.f)("value", todo.uid, 0)} class="${"svelte-q3kvo1"}">
				<input aria-label="${"Edit todo"}" type="${"text"}" name="${"text"}"${(0, import_index_4688debc.f)("value", todo.text, 0)} class="${"svelte-q3kvo1"}">
				<button class="${"save svelte-q3kvo1"}" aria-label="${"Save todo"}"></button></form>

			<form action="${"/todos?_method=DELETE"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${(0, import_index_4688debc.f)("value", todo.uid, 0)} class="${"svelte-q3kvo1"}">
