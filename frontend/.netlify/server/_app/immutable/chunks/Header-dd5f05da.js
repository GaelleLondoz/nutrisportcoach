...
const Header = (0, import_index_a7d28e02.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `${data && mounted ? `<header class="${"md:flex md:items-center relative z-20 svelte-12yz7zs"}"><nav class="${"nav container md:flex md:justify-between md:items-center svelte-12yz7zs"}">${smallViewport ? `<input class="${"checkbox svelte-12yz7zs"}" type="${"checkbox"}" name="${""}" id="${""}"${(0, import_index_a7d28e02.b)("checked", checked, 1)}>
      ...
      <div class="${"nav__header svelte-12yz7zs"}">${smallViewport ? `<div class="${"hamburger-lines svelte-12yz7zs"}"><span class="${"line line1 svelte-12yz7zs"}"></span>
        ...
        <a sveltekit:prefetch href="${"/"}" class="${"no-underline svelte-12yz7zs"}"><img src="${"https://res.cloudinary.com/gaellecloudinary/image/upload/f_auto,q_auto/" + (0, import_index_a7d28e02.e)(logoBigUrl, true)}"${(0, import_index_a7d28e02.b)("alt", logoBigAlt, 0)} class="${"logo logo--big svelte-12yz7zs"}"></a></div>

      ${!smallViewport ? `<div class="${"menu-items--desktop svelte-12yz7zs"}"><ul class="${"md:flex p-0 list-none svelte-12yz7zs"}">${(0, import_index_a7d28e02.d)(items, ({ label, page: { data: { attributes: { url } } } }) => {
    return `<li class="${[
      "svelte-12yz7zs",
      (!$page.url.pathname.includes("/a-propos") ? $page.url.pathname.includes(url) : url.includes("/a-propos")) ? "active" : ""
    ].join(" ").trim()}"><a sveltekit:prefetch${(0, import_index_a7d28e02.b)("href", url, 0)} class="${"no-underline svelte-12yz7zs"}">${(0, import_index_a7d28e02.e)(label)}</a>
              </li>`;
  })}</ul></div>` : `<div class="${"menu-items--mobile svelte-12yz7zs"}"><a sveltekit:prefetch href="${"/"}" class="${"no-underline svelte-12yz7zs"}"><img src="${"https://res.cloudinary.com/gaellecloudinary/image/upload/f_auto,q_auto/" + (0, import_index_a7d28e02.e)(logoSmallUrl, true)}"${(0, import_index_a7d28e02.b)("alt", logoSmallAlt, 0)} class="${"logo logo--small svelte-12yz7zs"}"></a>

          <ul class="${"md:flex p-0 list-none svelte-12yz7zs"}">${(0, import_index_a7d28e02.d)(items, ({ label, page: { data: { attributes: { url } } } }) => {
    return `<li class="${["svelte-12yz7zs", $page.url.pathname.includes(url) ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch${(0, import_index_a7d28e02.b)("href", url, 0)} class="${"no-underline svelte-12yz7zs"}">${(0, import_index_a7d28e02.e)(label)}</a>
              </li>`;
  })}</ul></div>`}</nav></header>` : ``}`;
});
