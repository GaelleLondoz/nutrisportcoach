...
const TabsItem = (0, import_index_a7d28e02.c)(($$result, $$props, $$bindings, slots) => {
  ...
  ].join(" ").trim()}"><a sveltekit:prefetch${(0, import_index_a7d28e02.b)("href", url, 0)} class="${"no-underline svelte-7x0bcu"}">${cloudinaryHash && alternativeText && smallViewport ? `<picture class="${"svelte-7x0bcu"}"><source srcset="${"https://res.cloudinary.com/gaellecloudinary/image/upload/f_auto,q_auto,w_250/" + (0, import_index_a7d28e02.e)(cloudinaryHash, true)}" media="${"(min-width: 1024px)"}" class="${"svelte-7x0bcu"}">

        <img src="${"https://res.cloudinary.com/gaellecloudinary/image/upload/f_auto,q_auto,w_80/" + (0, import_index_a7d28e02.e)(cloudinaryHash, true)}"${(0, import_index_a7d28e02.b)("alt", alternativeText, 0)} class="${"svelte-7x0bcu"}"></picture>` : ``}
...
const TabsList = (0, import_index_a7d28e02.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${(data == null ? void 0 : data.length) ? `<nav class="${"nav container svelte-1869ru2"}"><div class="${"tabs-items svelte-1869ru2"}"><ul class="${["svelte-1869ru2", tabsWithImages ? "with-image" : ""].join(" ").trim()}">${(0, import_index_a7d28e02.d)(data, (tab) => {
